    ...
    if not grop.text[0].isalpha() and grop.text[0] not in ("/", "#", "@", "!"):
        ...
        if type_of_group == "b":
            ...
            try:
                ...
                await grop.edit("Your `{}` Group Made Master!. Join [{}]({})".format(group_name, group_name, result.link))
            ...
            try:
                ...
                r = await grop.client(functions.channels.CreateChannelRequest(  # pylint:disable=E0602
                    ...
                    about="Welcome to this Channel Master",
                ...
                await grop.edit("Your `{}` Group/Channel Has been made Master!. Join [{}]({})".format(group_name, group_name, result.link))
