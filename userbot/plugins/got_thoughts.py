...
async def _(event):
    ...
    if x==30:
        ...
        await event.edit("`\"A girl is Arya CAGE of Winterfell. And I'm going home.\"`")
    ...
    if x==33:
        ...
        await event.edit("`\"Lannister, Targaryen, Baratheon, CAGE, Tyrell... they're all just spokes on a wheel. This one's on top, then that one's on top, and on and on it spins, crushing those on the ground.\"`")
