...
if PMPERMIT_PIC is None:
  WARN_PIC = "https://telegra.ph/file/c13167da56a3e3f2033b5.jpg"
else:
...
CUSTOM_MIDDLE_PMP = str(CUSTOM_PMPERMIT) if CUSTOM_PMPERMIT else "**YOU HAVE ARRIVED TO MY MASTERS INBOX** \n`THIS IS ILLEGAL AND REGARDED AS A CRIME`"
USER_BOT_WARN_ZERO = "`You were spamming my Master's inbox, henceforth your retarded lame ass has been blocked by my master's USER X.` "
USER_BOT_NO_WARN = ("`Hello ! This is` **CAGE USER X**\n"
...
async def hehehe(event):
    ...
    if event.is_private:
        if not pmpermit_sql.is_approved(chat.id):
            pmpermit_sql.approve(chat.id, "**My Master Is Best🔥**")
